        ...
        child: Row(
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  Icon(Icons.remove,size: Dimensions.iconSize24, color: AppColors.signColor,),
                  SizedBox(width: Dimensions.width10/2,),
                  BigText(text: "0"),
                  SizedBox(width: Dimensions.width10/2,),
                  Icon(Icons.add,size: Dimensions.iconSize24, color: AppColors.signColor,)
                ],
              ),
            ),
            //amount widget
